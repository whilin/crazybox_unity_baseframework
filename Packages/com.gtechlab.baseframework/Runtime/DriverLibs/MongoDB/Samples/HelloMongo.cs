...
//	//string connectionString = "mongodb://ketta_editor:ketta_editor@kettadevcluster0-shard-00-00-aps0z.mongodb.net:27017/test";
////	string connectionString = "mongodb://kettadevcluster0-shard-00-00-aps0z.mongodb.net:27017";

//	// string connectionString = "mongodb://ketta_editor:ketta_editor@kettadevcluster0-shard-00-00-aps0z.mongodb.net:27017,"+
//	// 															  "kettadevcluster0-shard-00-01-aps0z.mongodb.net:27017,"+
//	// 															  "kettadevcluster0-shard-00-02-aps0z.mongodb.net:27017"+
//	// 															  "/test?ssl=true&replicaSet=KettaDevCluster0-shard-0&authSource=admin&retryWrites=true";
//	// string connectionString = "mongodb://ketta_editor:ketta_editor@kettadevcluster0-shard-00-00-aps0z.mongodb.net:27017,"+
//	// 															  "kettadevcluster0-shard-00-01-aps0z.mongodb.net:27017,"+
//	// 															  "kettadevcluster0-shard-00-02-aps0z.mongodb.net:27017"+
//	// 															  "/test?ssl=true&replicaSet=KettaDevCluster0-shard-0&authSource=admin";

//	string connectionString = "mongodb://ec2-18-222-248-11.us-east-2.compute.amazonaws.com:27017";
...
//		var state = database.GetStats();
//		Debug.Log ("GetStats:"+state);
