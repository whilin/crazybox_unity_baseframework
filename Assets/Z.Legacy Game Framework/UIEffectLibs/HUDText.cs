...
public class HUDText : MonoBehaviour
{
	...
	void Update ()
	{
		...
		for (int i = mList.Count; i > 0; )
		{
			...
			//ent.label.cachedTransform.localPosition = new Vector3(ent.label.cachedTransform.localPosition.x, offset, ent.label.cachedTransform.localPosition.z);
			ent.label.cachedTransform.localPosition = new Vector3(0, offset, 0);
		}
	}
}
